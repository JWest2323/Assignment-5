  ...
  function($scope, $location, $stateParams, $state, Listings){
    ...
    $scope.create = function(isValid) {
      ...
      $scope.update = function(isValid) {
          ...
          Listings.update($stateParams.listingId, listing)
              .then(function(response) {
                  //if the object is successfully saved redirect back to the list page
                  $state.go('listings.list', { successMessage: 'Listing updated successfully!' });
              }, function(error) {
                  //otherwise display the error
    ...
    $scope.remove = function() {
      ...
      Listings.delete($stateParams.listingId)
          .then(function(response) {
              // if the object is saved successfully, rtn to list page and display success message
              $state.go('listings.list', {successMessage: 'Listing was successfully deleted!'});
          }, function(error) {
